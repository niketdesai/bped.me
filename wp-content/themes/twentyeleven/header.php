...
<body <?php body_class(); ?>>
	...
	<div class="container">
		...
		<header>
			<div id="logomast" class="float-left">
				<a href="/"><img src="wp-content/themes/twentyeleven/images/bpe-logo.png" alt="BPEDME LOGO" /></a>
			</div>
			<nav class="header">
				<ul>
	...
	<div class="container">
		...
		<div id="main-content">
			...
			<section id="carousel">
				<img src="wp-content/themes/twentyeleven/images/landing_img.jpg" alt="about-us">					
			</section>
		</div>
		<!-- MAIN-CONTENT END -->
	</div>
